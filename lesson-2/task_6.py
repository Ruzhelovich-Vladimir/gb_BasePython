...
for ELEM in USR_LIST:
    for KEY, VALUE in ELEM[1].items():
        if DICT_RESULT.get(KEY, False):
            # Добавляем элемент в список, если он уже создан
            DICT_RESULT[KEY].append(VALUE)
            # Убераем дубли из списка
            DICT_RESULT[KEY] = list(set(DICT_RESULT[KEY]))
        else:
            # Инициализируем список
            DICT_RESULT[KEY] = [VALUE]

print(f"Исходные данные: {USR_LIST}")
